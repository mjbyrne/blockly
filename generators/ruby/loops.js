...
/**
 * @fileoverview Generating Ruby for loop blocks.
...
Blockly.Ruby['controls_repeat_ext'] = function(block) {
  ...
  branch = Blockly.Ruby.addLoopTrap(branch, block.id) ||
      Blockly.Ruby.PASS;
  var loopVar = Blockly.Ruby.variableDB_.getDistinctName(
      'count', Blockly.Variables.NAME_TYPE);
  var code = 'loopVar = ' + repeats + '\n' + 'for i in 1..' + loopVar + '\n' + '     ' + branch + '\n' + 'end';
  return code;
};
...
Blockly.Ruby['controls_whileUntil'] = function(block) {
  // while loop
  //everything between here and the return is not language specific
...
//this section taken from the python code, does not seem applicable to ruby
//will need to figure out how to remove from list of option on blockly so it doesn't show up as selectable
...
Blockly.Ruby['controls_for'] = function(block) {
  ...
  // Arguments are legal Ruby code (numbers or strings returned by scrub()).
  ...
  if (Blockly.isNumber(argument0) && Blockly.isNumber(argument1) &&
    ...
    var scrub = function(arg, suffix) {
      if (Blockly.isNumber(arg)) {
        ...
        // It's complicated.
        var varName = Blockly.Ruby.variableDB_.getDistinctName(
